/****************************************************************************
** Meta object code from reading C++ file 'file_server.h'
**
...
#error "The header file 'file_server.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 32, 20), // "handleHttpConnection"
QT_MOC_LITERAL(4, 53, 16), // "handleClientData"
QT_MOC_LITERAL(5, 70, 11), // "QTcpSocket*"
QT_MOC_LITERAL(6, 82, 6) // "client"

    },
    "FileServer\0handleNewConnection\0\0"
    "handleHttpConnection\0handleClientData\0"
    "QTcpSocket*\0client"
};
...
void FileServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->handleHttpConnection(); break;
        case 2: _t->handleClientData((*reinterpret_cast< QTcpSocket*(*)>(_a[1]))); break;
        default: ;
        }
